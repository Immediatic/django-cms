...
class AbstractPagePermission(models.Model):
    ...
    """
    # who:
    user = models.ForeignKey(get_user_model(), verbose_name=_("user"), blank=True, null=True)
...
class PageUser(get_user_model()):
    ...
    """
    created_by = models.ForeignKey(get_user_model(), related_name="created_users")
...
class PageUserGroup(Group):
    ...
    """
    created_by = models.ForeignKey(get_user_model(), related_name="created_usergroups")
